...
function updateFilters() {
  ...
  function filterTable() {
    ...
    // First attemp: code works but refactored to above line, couldn't figure out intially 
    // how to replace row.state with variable, tried row.key which didn't work
    // for ([key,val] of Object.entries(filters)) {
